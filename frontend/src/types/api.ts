...
export type ApplyRevocationCertRequest = components["schemas"]["ApplyRevocationCertRequest"]
...
export type ExportPrivateRequest = components["schemas"]["ExportPrivateRequest"]
