...
- **Create primary key UX:** dedicated page at `/keys/new` (not a modal on `/keys`). Phase 1 (implemented): form + `keysApi.create()` + `[pgp-ui]` event IDs. Phase 2: import/register; Phase 3: detail + lifecycle.
