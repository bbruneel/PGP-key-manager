...
- **Node.js 24.16.0** and **npm 11.13.0** are managed via **nvm**. The update script runs `nvm install` from `.nvmrc` automatically. Before running any `npm` command in a new shell, load nvm and activate the pinned version:
  ```bash
