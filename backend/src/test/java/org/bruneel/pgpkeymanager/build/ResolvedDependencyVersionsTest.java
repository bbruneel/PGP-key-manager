...
class ResolvedDependencyVersionsTest {
    ...
    void isAtLeastComparesNumericSegments() {
        assertThat(DependencyVersions.isAtLeast("1.5.35", "1.5.35")).isTrue();
        assertThat(DependencyVersions.isAtLeast("1.5.36", "1.5.35")).isTrue();
        assertThat(DependencyVersions.isAtLeast("1.5.34", "1.5.35")).isFalse();
